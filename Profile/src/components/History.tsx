...
const History = () => {
  return (
    <div className="bg-[whitesmoke] my-[5%] mx-[5%] px-4 rounded shadow-md">
        ...
        <span className="my-4 border-l-8 border-gray-800 tracking-wide flex items-start pl-4  justify-start h-max">BOE limited has established a long-term commercial relationship with reputable and business savvy companies. In this instance, we anticipate that companies to fulfill the commitment
