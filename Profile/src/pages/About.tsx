...
const AchievementsSection = () => (
  ...
  >
    <p className="text-lg text-gray-700">
      BOE Minerals has achieved numerous milestones, recognized for excellence and innovation. Our products are used across various applications, including jewelry and electronics. We are proud of our accomplishments and look forward to continuing to serve our customers.
    </p>
  </SectionWrapper>
);
...
const DownloadSection = () => (
  <div className="bg-blue-50 p-8 rounded-lg shadow-lg text-center mb-8">
    ...
    <a
      href="/BOE_Minerals.pdf"
      download="BOE_Minerals.pdf"
