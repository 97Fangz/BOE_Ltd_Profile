...
const Services: React.FC = () => {
  return (
    <div className="relative flex min-h-screen flex-col bg-cream-white overflow-x-hidden" style={{ fontFamily: 'Inter, "Noto Sans", sans-serif' }}>
      <h1 className='text-2xl font-semibold text-amber-900 border-b-2 border-amber-900 py-4 text-center'>
        Our Services
      </h1>
      <div className="flex flex-col items-center py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <div className="flex flex-col bg-cream-white rounded-lg border border-amber-300 p-6 text-center shadow-lg">
              ...
              <h2 className="text-amber-900 text-lg font-semibold mb-2">Worldwide Shipment</h2>
              <p className="text-gray-600">
                We offer global shipping solutions, ensuring timely and secure delivery of your precious metals to any destination around the world.
              </p>
            </div>
            ...
            <div className="flex flex-col bg-cream-white rounded-lg border border-amber-300 p-6 text-center shadow-lg">
              ...
              <h2 className="text-amber-900 text-lg font-semibold mb-2">FOB & CIF Terms</h2>
              <p className="text-gray-600">
                We provide flexible shipping terms including FOB (Free on Board) and CIF (Cost, Insurance, and Freight) to cater to your specific needs and preferences.
              </p>
            </div>
            ...
            <div className="flex flex-col bg-cream-white rounded-lg border border-amber-300 p-6 text-center shadow-lg">
              ...
              <h2 className="text-amber-900 text-lg font-semibold mb-2">Payment Options</h2>
              <p className="text-gray-600">
                We offer various payment options including bank transfers and credit facilities to ensure convenience and flexibility for our clients.
              </p>
            </div>
