        ...
        <div className="px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(158px,1fr))] gap-3 p-4">
              <div className="flex flex-1 gap-3 rounded-lg border border-[#3d4852] bg-[#1c2226] p-4 items-center">
              ...
              <div className="flex flex-1 gap-3 rounded-lg border border-[#3d4852] bg-[#1c2226] p-4 items-center">
                ...
                <h2 className="text-white text-base font-bold leading-tight">FOB & CIF Terms</h2>
              </div>
              <div className="flex flex-1 gap-3 rounded-lg border border-[#3d4852] bg-[#1c2226] p-4 items-center">
                <div className="text-white" data-icon="Bank" data-size="24px" data-weight="regular">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
                ...
                <h2 className="text-white text-base font-bold leading-tight">Payment Options</h2>
              </div>
              <div className="flex flex-1 gap-3 rounded-lg border border-[#3d4852] bg-[#1c2226] p-4 items-center">
                ...
                <h2 className="text-white text-base font-bold leading-tight">Assured Quality</h2>
              </div>
            </div>
          </div>
        </div>
